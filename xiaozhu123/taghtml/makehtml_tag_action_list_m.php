...
{ 
    ...
    $gourl = "makehtml_tag_action_list_m.php?typeid={$typeid}&all={$all}&maxpagesize={$maxpagesize}&do=1";
...
{  
    ...
    $tag_basedir = empty($tag_basedir) ? '/m/tag' : $tag_basedir; 
    $tid = '';
    ...
    {   
        ...
        if ($nic_make) {
            require_once("arc.taghtml.class_m.php");	
    ...
    if($finishType)
    {
        $gourl = "makehtml_tag_action_list_m.php?uppage=1&maxpagesize=$maxpagesize&typeid=$typeid&pageno=$nextpage&all=$all&do=1";
    ...
    {
        $gourl = "makehtml_tag_action_list_m.php?uppage=1&mkpage=$mkpage&maxpagesize=$maxpagesize&typeid=$typeid&pageno=$pageno&all=$all&more=1&totals=$ntotalpage&do=1";
