...
function GetUpdateTest()
{
	...
	while($row=$dsql->GetObject('al')){     
		$revalue .= "\r\n<iframe name='stafrm' frameborder='0' id='stafrm' width='100%' height='40px' src='taghtml/makehtml_tag_action_list.php?typeid=".$row->tid."' style='display:none;'></iframe><br>";
$revalue .= "\r\n<iframe name='stafrm' frameborder='0' id='stafrm' width='100%' height='40px' src='taghtml/makehtml_tag_action_list_m.php?typeid=".$row->tid."' style='display:none;'></iframe><br>";      		
	}			    
    $revalue .= "\r\n<iframe name='stafrm' frameborder='0' id='stafrm' width='100%' height='100px' src='taghtml/makehtml_tag_action_index.php' style='display:none;'></iframe><br>";
	$revalue .= "\r\n<iframe name='stafrm' frameborder='0' id='stafrm' width='100%' height='100px' src='taghtml/makehtml_tag_action_index_m.php' style='display:none;'></iframe><br>";
    //add by 六久阁
    return $revalue;
}