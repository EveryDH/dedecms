 ...
 * TAG���ñ�ǩ
 *
 * @version        $Id: tag.lib.php 1 9:29 2010��7��6��Z tianya $
...
<type>ȫ�ֱ��</type>
<for>V55,V56,V57</for>
<description>TAG���ñ�ǩ</description>
<demo>
...
<attributes>
    <iterm>row:��������</iterm>
    <iterm>sort:����ʽ month��rand��week</iterm>
    <iterm>getall:��ȡ���� 0 Ϊ��ǰ����ҳTAG��ǣ�1Ϊ��ȡȫ��TAG���</iterm>
</attributes> 
>>dede>>*/
